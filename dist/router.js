...
var routes = [
    {
        ...
        "UPSTREAM-DOMAIN": "localhost",
        "UPSTREAM-PORT": 3031,
        "UPSTREAM-ENDPOINT": "/api/order",
        "DOWNSTREAM-ENDPOINT": "/feeds"
    },
    {
        "TENANT": "Jaadu",
        "METHOD": "post",
        ...
        "UPSTREAM-DOMAIN": "localhost",
        "UPSTREAM-PORT": 3031,
        "UPSTREAM-ENDPOINT": "/api/productOrderScreenViewList",
        "DOWNSTREAM-ENDPOINT": "/feeder"
    }
];
router.use((req, res, next) => {
    ...
    if (getTenant) {
        var route;
        dbModel_1.default.find({ TENANT: getTenant }).then(allroutesForTenant => {
